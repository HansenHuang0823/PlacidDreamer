...
if __name__ == "__main__":
    ...
    unet = Unet2DConditionModelFor3D.from_pretrained("bennyguo/zero123-xl-diffusers", subfolder="unet", torch_dtype=torch.float16)
    pipe_kwargs = {
            "safety_checker": None,
            "requires_safety_checker": False,
        }

    pipeline = Zero123PipelineFor3D.from_pretrained("bennyguo/zero123-xl-diffusers", unet=unet, **pipe_kwargs, torch_dtype=torch.float16)
